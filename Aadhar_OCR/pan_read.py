...
# Cleaning first names
        text0 = findword(text1, '(Name|Nome)$')
        name = text0[0]
        name = name.rstrip()
        name = name.lstrip()
...
# Cleaning Father's name
        text0 = findword(text1, '(Fother\'s|Father\'s|Father\'8|Fother\'8|Fother|Father\'s Name|Father\'s Nome|Fator\'s)$')
...
# Cleaning DOB
        text0 = findword(text1, '(DOB|dob|Date|Date Of Birth|Dote 0f Blrth|Date of Birth)$')
